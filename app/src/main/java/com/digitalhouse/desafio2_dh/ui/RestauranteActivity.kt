...
class RestauranteActivity : AppCompatActivity() {
    ...
    fun getAllPratos() = arrayListOf(
        Prato(resources.getIdentifier("image4", "drawable", packageName), "Salada com molho Gengibre", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tincidunt bibendum porta. Aenean mattis dolor erat, id tristique elit fringilla eu. Curabitur volutpat mi non quam vulputate, quis auctor massa efficitur."),
        Prato(resources.getIdentifier("image4", "drawable", packageName), "Salada com molho Gengibre", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tincidunt bibendum porta. Aenean mattis dolor erat, id tristique elit fringilla eu. Curabitur volutpat mi non quam vulputate, quis auctor massa efficitur."),
        Prato(resources.getIdentifier("image4", "drawable", packageName), "Salada com molho Gengibre", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tincidunt bibendum porta. Aenean mattis dolor erat, id tristique elit fringilla eu. Curabitur volutpat mi non quam vulputate, quis auctor massa efficitur."),
        Prato(resources.getIdentifier("image4", "drawable", packageName), "Salada com molho Gengibre", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tincidunt bibendum porta. Aenean mattis dolor erat, id tristique elit fringilla eu. Curabitur volutpat mi non quam vulputate, quis auctor massa efficitur."),
        Prato(resources.getIdentifier("image4", "drawable", packageName), "Salada com molho Gengibre", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tincidunt bibendum porta. Aenean mattis dolor erat, id tristique elit fringilla eu. Curabitur volutpat mi non quam vulputate, quis auctor massa efficitur."),
